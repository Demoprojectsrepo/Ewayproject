sap.ui.define([
	...
	return Controller.extend("einvoiceewaybill.controller.einvoiceprint", {
		...
		onInit: function () {
            ...
            this.getView().setModel(json, "dataprint")

            var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
            oRouter.getRoute("E-InvoicePrint").attachPatternMatched(this._onObjectMatched, this);
		},
