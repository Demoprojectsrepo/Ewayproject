		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#einvoiceewaybill-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"einvoiceewaybill-display": {
								"semanticObject": "einvoiceewaybill",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=einvoiceewaybill",
									"url": sap.ui.require.toUrl("einvoiceewaybill")
								}
							}
						}
					}
